...
public class App {
	...
	public static void main(String[] args) throws ParseException {
		...
		Veterinario  veterinario01 = new Veterinario("Pedro", "000.000.000.00", "Rua. Figueira lima", "João Pessoa", "Paraiba", "(83)99999-9999", "(83)99999-9999", 2521, "Medico Veterinario", 5525.50);
		...
		responsavel01.setAnimal(animal01);
