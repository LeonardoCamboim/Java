...
public final class Passaro extends Animal {
	...
	public Passaro(Responsavel responsavel, Veterinario veterinario, String sexo) {
		super(responsavel, veterinario, sexo);
	}
	
	public Passaro(String nome, Responsavel responsavel, Veterinario veterinario, String sexo) {
